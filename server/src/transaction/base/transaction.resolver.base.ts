...
export class TransactionResolverBase {
  ...
  async createTransaction(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        creditedAccount: args.data.creditedAccount
          ? {
              connect: args.data.creditedAccount,
            }
          : undefined,

        debitedAccount: args.data.debitedAccount
          ? {
              connect: args.data.debitedAccount,
            }
          : undefined,
      },
    });
  ...
  async creditedAccount(
    ...
    const result = await this.service.getCreditedAccount(parent.id);
  ...
  async debitedAccount(
    ...
    const result = await this.service.getDebitedAccount(parent.id);

...
export class AccountResolverBase {
  ...
  async creditedtransactions(
    ...
    const results = await this.service.findCreditedtransactions(
      parent.id,
      args
    );
  ...
  async debitedTransactions(
    ...
    const results = await this.service.findDebitedTransactions(parent.id, args);
